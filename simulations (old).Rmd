...
repeat {
   ...
   if (((it/parallelimp)-1)%%(holecycle*datbatches)==0) {
     ...
     wtssim1=rexp(n,1/9)+1
     wtssim2=rexp(n,1/9)+1
     wtssim1=wtssim1/min(wtssim1)
     wtssim2=wtssim2/min(wtssim2)
...
outlistcont=validatecleaner(c(outlistcont,validatedcont1,validatedcont2,validatedcont3))
   ...
   if (length(imputedsim111)>=rubindatasets) {
     cat("rubin-validating") #rubin-validating with rubindatasets1
     for (xa in 1:(length(imputedsim111)%/%rubindatasets)) {
 
       #rubin-validating simulations algorithm
rubinlistsim1[[length(rubinlistsim1)+1]]=rubinvalidator(imputedsim111[(1+(xa-1)*rubindatasets):(xa*rubindatasets)],datasim11,truevalssim1,response,explanatory,frac=frac1,maxits=maxits1,datinpool=rubindatasets)
rubinlistsim1[[length(rubinlistsim1)+1]]=rubinvalidator(imputedsim112[(1+(xa-1)*rubindatasets):(xa*rubindatasets)],datasim11,truevalssim1,response,explanatory,frac=frac1,maxits=maxits2,datinpool=rubindatasets)
rubinlistsim1[[length(rubinlistsim1)+1]]=rubinvalidator(imputedsim113[(1+(xa-1)*rubindatasets):(xa*rubindatasets)],datasim11,truevalssim1,response,explanatory,frac=frac1,maxits=maxits3,datinpool=rubindatasets)
rubinlistsim1[[length(rubinlistsim1)+1]]=rubinvalidator(imputedsim121[(1+(xa-1)*rubindatasets):(xa*rubindatasets)],datasim12,truevalssim1,response,explanatory,frac=frac2,maxits=maxits1,datinpool=rubindatasets)
rubinlistsim1[[length(rubinlistsim1)+1]]=rubinvalidator(imputedsim122[(1+(xa-1)*rubindatasets):(xa*rubindatasets)],datasim12,truevalssim1,response,explanatory,frac=frac2,maxits=maxits2,datinpool=rubindatasets)
rubinlistsim1[[length(rubinlistsim1)+1]]=rubinvalidator(imputedsim123[(1+(xa-1)*rubindatasets):(xa*rubindatasets)],datasim12,truevalssim1,response,explanatory,frac=frac2,maxits=maxits3,datinpool=rubindatasets)
rubinlistsim1[[length(rubinlistsim1)+1]]=rubinvalidator(imputedsim131[(1+(xa-1)*rubindatasets):(xa*rubindatasets)],datasim13,truevalssim1,response,explanatory,frac=frac3,maxits=maxits1,datinpool=rubindatasets)
rubinlistsim1[[length(rubinlistsim1)+1]]=rubinvalidator(imputedsim132[(1+(xa-1)*rubindatasets):(xa*rubindatasets)],datasim13,truevalssim1,response,explanatory,frac=frac3,maxits=maxits2,datinpool=rubindatasets)
rubinlistsim1[[length(rubinlistsim1)+1]]=rubinvalidator(imputedsim133[(1+(xa-1)*rubindatasets):(xa*rubindatasets)],datasim13,truevalssim1,response,explanatory,frac=frac3,maxits=maxits3,datinpool=rubindatasets)
rubinlistsim2[[length(rubinlistsim2)+1]]=rubinvalidator(imputedsim211[(1+(xa-1)*rubindatasets):(xa*rubindatasets)],datasim21,truevalssim2,response,explanatory,frac=frac1,maxits=maxits1,datinpool=rubindatasets)
rubinlistsim2[[length(rubinlistsim2)+1]]=rubinvalidator(imputedsim212[(1+(xa-1)*rubindatasets):(xa*rubindatasets)],datasim21,truevalssim2,response,explanatory,frac=frac1,maxits=maxits2,datinpool=rubindatasets)
rubinlistsim2[[length(rubinlistsim2)+1]]=rubinvalidator(imputedsim213[(1+(xa-1)*rubindatasets):(xa*rubindatasets)],datasim21,truevalssim2,response,explanatory,frac=frac1,maxits=maxits3,datinpool=rubindatasets)
rubinlistsim2[[length(rubinlistsim2)+1]]=rubinvalidator(imputedsim221[(1+(xa-1)*rubindatasets):(xa*rubindatasets)],datasim22,truevalssim2,response,explanatory,frac=frac2,maxits=maxits1,datinpool=rubindatasets)
rubinlistsim2[[length(rubinlistsim2)+1]]=rubinvalidator(imputedsim222[(1+(xa-1)*rubindatasets):(xa*rubindatasets)],datasim22,truevalssim2,response,explanatory,frac=frac2,maxits=maxits2,datinpool=rubindatasets)
rubinlistsim2[[length(rubinlistsim2)+1]]=rubinvalidator(imputedsim223[(1+(xa-1)*rubindatasets):(xa*rubindatasets)],datasim22,truevalssim2,response,explanatory,frac=frac2,maxits=maxits3,datinpool=rubindatasets)
rubinlistsim2[[length(rubinlistsim2)+1]]=rubinvalidator(imputedsim231[(1+(xa-1)*rubindatasets):(xa*rubindatasets)],datasim23,truevalssim2,response,explanatory,frac=frac3,maxits=maxits1,datinpool=rubindatasets)
rubinlistsim2[[length(rubinlistsim2)+1]]=rubinvalidator(imputedsim232[(1+(xa-1)*rubindatasets):(xa*rubindatasets)],datasim23,truevalssim2,response,explanatory,frac=frac3,maxits=maxits2,datinpool=rubindatasets)
rubinlistsim2[[length(rubinlistsim2)+1]]=rubinvalidator(imputedsim233[(1+(xa-1)*rubindatasets):(xa*rubindatasets)],datasim23,truevalssim2,response,explanatory,frac=frac3,maxits=maxits3,datinpool=rubindatasets)
 
       #rubin-validating simulations control
rubinlistsimcont1[[length(rubinlistsimcont1)+1]]=rubinvalidator(imputedsimcont11[(1+(xa-1)*rubindatasets):(xa*rubindatasets)],datasim11,truevalssim1,response,explanatory,frac=frac1,maxits=1,datinpool=rubindatasets)
rubinlistsimcont1[[length(rubinlistsimcont1)+1]]=rubinvalidator(imputedsimcont12[(1+(xa-1)*rubindatasets):(xa*rubindatasets)],datasim12,truevalssim1,response,explanatory,frac=frac2,maxits=1,datinpool=rubindatasets)
rubinlistsimcont1[[length(rubinlistsimcont1)+1]]=rubinvalidator(imputedsimcont13[(1+(xa-1)*rubindatasets):(xa*rubindatasets)],datasim13,truevalssim1,response,explanatory,frac=frac3,maxits=1,datinpool=rubindatasets)
rubinlistsimcont2[[length(rubinlistsimcont2)+1]]=rubinvalidator(imputedsimcont21[(1+(xa-1)*rubindatasets):(xa*rubindatasets)],datasim21,truevalssim2,response,explanatory,frac=frac1,maxits=1,datinpool=rubindatasets)
rubinlistsimcont2[[length(rubinlistsimcont2)+1]]=rubinvalidator(imputedsimcont22[(1+(xa-1)*rubindatasets):(xa*rubindatasets)],datasim22,truevalssim2,response,explanatory,frac=frac2,maxits=1,datinpool=rubindatasets)
rubinlistsimcont2[[length(rubinlistsimcont2)+1]]=rubinvalidator(imputedsimcont23[(1+(xa-1)*rubindatasets):(xa*rubindatasets)],datasim23,truevalssim2,response,explanatory,frac=frac3,maxits=1,datinpool=rubindatasets)
 
       #rubin-validating real algorithm
rubinlist[[length(rubinlist)+1]]=rubinvalidator(imputed11[(1+(xa-1)*rubindatasets):(xa*rubindatasets)],data1,truevals,response,explanatory,frac=frac1,maxits=maxits1,datinpool=rubindatasets)
rubinlist[[length(rubinlist)+1]]=rubinvalidator(imputed12[(1+(xa-1)*rubindatasets):(xa*rubindatasets)],data1,truevals,response,explanatory,frac=frac1,maxits=maxits2,datinpool=rubindatasets)
rubinlist[[length(rubinlist)+1]]=rubinvalidator(imputed13[(1+(xa-1)*rubindatasets):(xa*rubindatasets)],data1,truevals,response,explanatory,frac=frac1,maxits=maxits3,datinpool=rubindatasets)
rubinlist[[length(rubinlist)+1]]=rubinvalidator(imputed21[(1+(xa-1)*rubindatasets):(xa*rubindatasets)],data2,truevals,response,explanatory,frac=frac2,maxits=maxits1,datinpool=rubindatasets)
rubinlist[[length(rubinlist)+1]]=rubinvalidator(imputed22[(1+(xa-1)*rubindatasets):(xa*rubindatasets)],data2,truevals,response,explanatory,frac=frac2,maxits=maxits2,datinpool=rubindatasets)
rubinlist[[length(rubinlist)+1]]=rubinvalidator(imputed23[(1+(xa-1)*rubindatasets):(xa*rubindatasets)],data2,truevals,response,explanatory,frac=frac2,maxits=maxits3,datinpool=rubindatasets)
rubinlist[[length(rubinlist)+1]]=rubinvalidator(imputed31[(1+(xa-1)*rubindatasets):(xa*rubindatasets)],data3,truevals,response,explanatory,frac=frac3,maxits=maxits1,datinpool=rubindatasets)
rubinlist[[length(rubinlist)+1]]=rubinvalidator(imputed32[(1+(xa-1)*rubindatasets):(xa*rubindatasets)],data3,truevals,response,explanatory,frac=frac3,maxits=maxits2,datinpool=rubindatasets)
rubinlist[[length(rubinlist)+1]]=rubinvalidator(imputed33[(1+(xa-1)*rubindatasets):(xa*rubindatasets)],data3,truevals,response,explanatory,frac=frac3,maxits=maxits3,datinpool=rubindatasets)
 
       #rubin-validating real control
rubinlistcont[[length(rubinlistcont)+1]]=rubinvalidator(imputedcont1[(1+(xa-1)*rubindatasets):(xa*rubindatasets)],data1,truevals,response,explanatory,frac=frac1,maxits=1,datinpool=rubindatasets)
rubinlistcont[[length(rubinlistcont)+1]]=rubinvalidator(imputedcont2[(1+(xa-1)*rubindatasets):(xa*rubindatasets)],data2,truevals,response,explanatory,frac=frac2,maxits=1,datinpool=rubindatasets)
rubinlistcont[[length(rubinlistcont)+1]]=rubinvalidator(imputedcont3[(1+(xa-1)*rubindatasets):(xa*rubindatasets)],data3,truevals,response,explanatory,frac=frac3,maxits=1,datinpool=rubindatasets)
...
rubinlistmice[[length(rubinlistmice)+1]]=rubinvalidator(micedats,data1,truevals,response,explanatory,frac=frac1,maxits=0,datinpool=rubindatasets)
...
rubinlistmice[[length(rubinlistmice)+1]]=rubinvalidator(micedats,data2,truevals,response,explanatory,frac=frac2,maxits=0,datinpool=rubindatasets)
...
rubinlistmice[[length(rubinlistmice)+1]]=rubinvalidator(micedats,data3,truevals,response,explanatory,frac=frac3,maxits=0,datinpool=rubindatasets)
     }
     ...
     for (xb in 1:(length(imputedsim111)%/%rubindatasets2)) {
       ...
       #rubin-validating simulations algorithm
rubinlistsim1[[length(rubinlistsim1)+1]]=rubinvalidator(imputedsim111[(1+(xb-1)*rubindatasets2):(xb*rubindatasets2)],datasim11,truevalssim1,response,explanatory,frac=frac1,maxits=maxits1,datinpool=rubindatasets2)
rubinlistsim1[[length(rubinlistsim1)+1]]=rubinvalidator(imputedsim112[(1+(xb-1)*rubindatasets2):(xb*rubindatasets2)],datasim11,truevalssim1,response,explanatory,frac=frac1,maxits=maxits2,datinpool=rubindatasets2)
rubinlistsim1[[length(rubinlistsim1)+1]]=rubinvalidator(imputedsim113[(1+(xb-1)*rubindatasets2):(xb*rubindatasets2)],datasim11,truevalssim1,response,explanatory,frac=frac1,maxits=maxits3,datinpool=rubindatasets2)
rubinlistsim1[[length(rubinlistsim1)+1]]=rubinvalidator(imputedsim121[(1+(xb-1)*rubindatasets2):(xb*rubindatasets2)],datasim12,truevalssim1,response,explanatory,frac=frac2,maxits=maxits1,datinpool=rubindatasets2)
rubinlistsim1[[length(rubinlistsim1)+1]]=rubinvalidator(imputedsim122[(1+(xb-1)*rubindatasets2):(xb*rubindatasets2)],datasim12,truevalssim1,response,explanatory,frac=frac2,maxits=maxits2,datinpool=rubindatasets2)
rubinlistsim1[[length(rubinlistsim1)+1]]=rubinvalidator(imputedsim123[(1+(xb-1)*rubindatasets2):(xb*rubindatasets2)],datasim12,truevalssim1,response,explanatory,frac=frac2,maxits=maxits3,datinpool=rubindatasets2)
rubinlistsim1[[length(rubinlistsim1)+1]]=rubinvalidator(imputedsim131[(1+(xb-1)*rubindatasets2):(xb*rubindatasets2)],datasim13,truevalssim1,response,explanatory,frac=frac3,maxits=maxits1,datinpool=rubindatasets2)
rubinlistsim1[[length(rubinlistsim1)+1]]=rubinvalidator(imputedsim132[(1+(xb-1)*rubindatasets2):(xb*rubindatasets2)],datasim13,truevalssim1,response,explanatory,frac=frac3,maxits=maxits2,datinpool=rubindatasets2)
rubinlistsim1[[length(rubinlistsim1)+1]]=rubinvalidator(imputedsim133[(1+(xb-1)*rubindatasets2):(xb*rubindatasets2)],datasim13,truevalssim1,response,explanatory,frac=frac3,maxits=maxits3,datinpool=rubindatasets2)
rubinlistsim2[[length(rubinlistsim2)+1]]=rubinvalidator(imputedsim211[(1+(xb-1)*rubindatasets2):(xb*rubindatasets2)],datasim21,truevalssim2,response,explanatory,frac=frac1,maxits=maxits1,datinpool=rubindatasets2)
rubinlistsim2[[length(rubinlistsim2)+1]]=rubinvalidator(imputedsim212[(1+(xb-1)*rubindatasets2):(xb*rubindatasets2)],datasim21,truevalssim2,response,explanatory,frac=frac1,maxits=maxits2,datinpool=rubindatasets2)
rubinlistsim2[[length(rubinlistsim2)+1]]=rubinvalidator(imputedsim213[(1+(xb-1)*rubindatasets2):(xb*rubindatasets2)],datasim21,truevalssim2,response,explanatory,frac=frac1,maxits=maxits3,datinpool=rubindatasets2)
rubinlistsim2[[length(rubinlistsim2)+1]]=rubinvalidator(imputedsim221[(1+(xb-1)*rubindatasets2):(xb*rubindatasets2)],datasim22,truevalssim2,response,explanatory,frac=frac2,maxits=maxits1,datinpool=rubindatasets2)
rubinlistsim2[[length(rubinlistsim2)+1]]=rubinvalidator(imputedsim222[(1+(xb-1)*rubindatasets2):(xb*rubindatasets2)],datasim22,truevalssim2,response,explanatory,frac=frac2,maxits=maxits2,datinpool=rubindatasets2)
rubinlistsim2[[length(rubinlistsim2)+1]]=rubinvalidator(imputedsim223[(1+(xb-1)*rubindatasets2):(xb*rubindatasets2)],datasim22,truevalssim2,response,explanatory,frac=frac2,maxits=maxits3,datinpool=rubindatasets2)
rubinlistsim2[[length(rubinlistsim2)+1]]=rubinvalidator(imputedsim231[(1+(xb-1)*rubindatasets2):(xb*rubindatasets2)],datasim23,truevalssim2,response,explanatory,frac=frac3,maxits=maxits1,datinpool=rubindatasets2)
rubinlistsim2[[length(rubinlistsim2)+1]]=rubinvalidator(imputedsim232[(1+(xb-1)*rubindatasets2):(xb*rubindatasets2)],datasim23,truevalssim2,response,explanatory,frac=frac3,maxits=maxits2,datinpool=rubindatasets2)
rubinlistsim2[[length(rubinlistsim2)+1]]=rubinvalidator(imputedsim233[(1+(xb-1)*rubindatasets2):(xb*rubindatasets2)],datasim23,truevalssim2,response,explanatory,frac=frac3,maxits=maxits3,datinpool=rubindatasets2)
 
       #rubin-validating simulations control
rubinlistsimcont1[[length(rubinlistsimcont1)+1]]=rubinvalidator(imputedsimcont11[(1+(xb-1)*rubindatasets2):(xb*rubindatasets2)],datasim11,truevalssim1,response,explanatory,frac=frac1,maxits=1,datinpool=rubindatasets2)
rubinlistsimcont1[[length(rubinlistsimcont1)+1]]=rubinvalidator(imputedsimcont12[(1+(xb-1)*rubindatasets2):(xb*rubindatasets2)],datasim12,truevalssim1,response,explanatory,frac=frac2,maxits=1,datinpool=rubindatasets2)
rubinlistsimcont1[[length(rubinlistsimcont1)+1]]=rubinvalidator(imputedsimcont13[(1+(xb-1)*rubindatasets2):(xb*rubindatasets2)],datasim13,truevalssim1,response,explanatory,frac=frac3,maxits=1,datinpool=rubindatasets2)
rubinlistsimcont2[[length(rubinlistsimcont2)+1]]=rubinvalidator(imputedsimcont21[(1+(xb-1)*rubindatasets2):(xb*rubindatasets2)],datasim21,truevalssim2,response,explanatory,frac=frac1,maxits=1,datinpool=rubindatasets2)
rubinlistsimcont2[[length(rubinlistsimcont2)+1]]=rubinvalidator(imputedsimcont22[(1+(xb-1)*rubindatasets2):(xb*rubindatasets2)],datasim22,truevalssim2,response,explanatory,frac=frac2,maxits=1,datinpool=rubindatasets2)
rubinlistsimcont2[[length(rubinlistsimcont2)+1]]=rubinvalidator(imputedsimcont23[(1+(xb-1)*rubindatasets2):(xb*rubindatasets2)],datasim23,truevalssim2,response,explanatory,frac=frac3,maxits=1,datinpool=rubindatasets2)
 
       #rubin-validating real algorithm
rubinlist[[length(rubinlist)+1]]=rubinvalidator(imputed11[(1+(xb-1)*rubindatasets2):(xb*rubindatasets2)],data1,truevals,response,explanatory,frac=frac1,maxits=maxits1,datinpool=rubindatasets2)
rubinlist[[length(rubinlist)+1]]=rubinvalidator(imputed12[(1+(xb-1)*rubindatasets2):(xb*rubindatasets2)],data1,truevals,response,explanatory,frac=frac1,maxits=maxits2,datinpool=rubindatasets2)
rubinlist[[length(rubinlist)+1]]=rubinvalidator(imputed13[(1+(xb-1)*rubindatasets2):(xb*rubindatasets2)],data1,truevals,response,explanatory,frac=frac1,maxits=maxits3,datinpool=rubindatasets2)
rubinlist[[length(rubinlist)+1]]=rubinvalidator(imputed21[(1+(xb-1)*rubindatasets2):(xb*rubindatasets2)],data2,truevals,response,explanatory,frac=frac2,maxits=maxits1,datinpool=rubindatasets2)
rubinlist[[length(rubinlist)+1]]=rubinvalidator(imputed22[(1+(xb-1)*rubindatasets2):(xb*rubindatasets2)],data2,truevals,response,explanatory,frac=frac2,maxits=maxits2,datinpool=rubindatasets2)
rubinlist[[length(rubinlist)+1]]=rubinvalidator(imputed23[(1+(xb-1)*rubindatasets2):(xb*rubindatasets2)],data2,truevals,response,explanatory,frac=frac2,maxits=maxits3,datinpool=rubindatasets2)
rubinlist[[length(rubinlist)+1]]=rubinvalidator(imputed31[(1+(xb-1)*rubindatasets2):(xb*rubindatasets2)],data3,truevals,response,explanatory,frac=frac3,maxits=maxits1,datinpool=rubindatasets2)
rubinlist[[length(rubinlist)+1]]=rubinvalidator(imputed32[(1+(xb-1)*rubindatasets2):(xb*rubindatasets2)],data3,truevals,response,explanatory,frac=frac3,maxits=maxits2,datinpool=rubindatasets2)
rubinlist[[length(rubinlist)+1]]=rubinvalidator(imputed33[(1+(xb-1)*rubindatasets2):(xb*rubindatasets2)],data3,truevals,response,explanatory,frac=frac3,maxits=maxits3,datinpool=rubindatasets2)
 
       #rubin-validating real control
rubinlistcont[[length(rubinlistcont)+1]]=rubinvalidator(imputedcont1[(1+(xb-1)*rubindatasets2):(xb*rubindatasets2)],data1,truevals,response,explanatory,frac=frac1,maxits=1,datinpool=rubindatasets2)
rubinlistcont[[length(rubinlistcont)+1]]=rubinvalidator(imputedcont2[(1+(xb-1)*rubindatasets2):(xb*rubindatasets2)],data2,truevals,response,explanatory,frac=frac2,maxits=1,datinpool=rubindatasets2)
rubinlistcont[[length(rubinlistcont)+1]]=rubinvalidator(imputedcont3[(1+(xb-1)*rubindatasets2):(xb*rubindatasets2)],data3,truevals,response,explanatory,frac=frac3,maxits=1,datinpool=rubindatasets2)
...
rubinlistmice[[length(rubinlistmice)+1]]=rubinvalidator(micedats,data1,truevals,response,explanatory,frac=frac1,maxits=0,datinpool=rubindatasets2)
...
rubinlistmice[[length(rubinlistmice)+1]]=rubinvalidator(micedats,data2,truevals,response,explanatory,frac=frac2,maxits=0,datinpool=rubindatasets2)
...
rubinlistmice[[length(rubinlistmice)+1]]=rubinvalidator(micedats,data3,truevals,response,explanatory,frac=frac3,maxits=0,datinpool=rubindatasets2)
     }
     ...
     for (xc in 1:(length(imputedsim111)%/%rubindatasets3)) {
       ...
       #rubin-validating simulations algorithm
rubinlistsim1[[length(rubinlistsim1)+1]]=rubinvalidator(imputedsim111[(1+(xc-1)*rubindatasets3):(xc*rubindatasets3)],datasim11,truevalssim1,response,explanatory,frac=frac1,maxits=maxits1,datinpool=rubindatasets3)
rubinlistsim1[[length(rubinlistsim1)+1]]=rubinvalidator(imputedsim112[(1+(xc-1)*rubindatasets3):(xc*rubindatasets3)],datasim11,truevalssim1,response,explanatory,frac=frac1,maxits=maxits2,datinpool=rubindatasets3)
rubinlistsim1[[length(rubinlistsim1)+1]]=rubinvalidator(imputedsim113[(1+(xc-1)*rubindatasets3):(xc*rubindatasets3)],datasim11,truevalssim1,response,explanatory,frac=frac1,maxits=maxits3,datinpool=rubindatasets3)
rubinlistsim1[[length(rubinlistsim1)+1]]=rubinvalidator(imputedsim121[(1+(xc-1)*rubindatasets3):(xc*rubindatasets3)],datasim12,truevalssim1,response,explanatory,frac=frac2,maxits=maxits1,datinpool=rubindatasets3)
rubinlistsim1[[length(rubinlistsim1)+1]]=rubinvalidator(imputedsim122[(1+(xc-1)*rubindatasets3):(xc*rubindatasets3)],datasim12,truevalssim1,response,explanatory,frac=frac2,maxits=maxits2,datinpool=rubindatasets3)
rubinlistsim1[[length(rubinlistsim1)+1]]=rubinvalidator(imputedsim123[(1+(xc-1)*rubindatasets3):(xc*rubindatasets3)],datasim12,truevalssim1,response,explanatory,frac=frac2,maxits=maxits3,datinpool=rubindatasets3)
rubinlistsim1[[length(rubinlistsim1)+1]]=rubinvalidator(imputedsim131[(1+(xc-1)*rubindatasets3):(xc*rubindatasets3)],datasim13,truevalssim1,response,explanatory,frac=frac3,maxits=maxits1,datinpool=rubindatasets3)
rubinlistsim1[[length(rubinlistsim1)+1]]=rubinvalidator(imputedsim132[(1+(xc-1)*rubindatasets3):(xc*rubindatasets3)],datasim13,truevalssim1,response,explanatory,frac=frac3,maxits=maxits2,datinpool=rubindatasets3)
rubinlistsim1[[length(rubinlistsim1)+1]]=rubinvalidator(imputedsim133[(1+(xc-1)*rubindatasets3):(xc*rubindatasets3)],datasim13,truevalssim1,response,explanatory,frac=frac3,maxits=maxits3,datinpool=rubindatasets3)
rubinlistsim2[[length(rubinlistsim2)+1]]=rubinvalidator(imputedsim211[(1+(xc-1)*rubindatasets3):(xc*rubindatasets3)],datasim21,truevalssim2,response,explanatory,frac=frac1,maxits=maxits1,datinpool=rubindatasets3)
rubinlistsim2[[length(rubinlistsim2)+1]]=rubinvalidator(imputedsim212[(1+(xc-1)*rubindatasets3):(xc*rubindatasets3)],datasim21,truevalssim2,response,explanatory,frac=frac1,maxits=maxits2,datinpool=rubindatasets3)
rubinlistsim2[[length(rubinlistsim2)+1]]=rubinvalidator(imputedsim213[(1+(xc-1)*rubindatasets3):(xc*rubindatasets3)],datasim21,truevalssim2,response,explanatory,frac=frac1,maxits=maxits3,datinpool=rubindatasets3)
rubinlistsim2[[length(rubinlistsim2)+1]]=rubinvalidator(imputedsim221[(1+(xc-1)*rubindatasets3):(xc*rubindatasets3)],datasim22,truevalssim2,response,explanatory,frac=frac2,maxits=maxits1,datinpool=rubindatasets3)
rubinlistsim2[[length(rubinlistsim2)+1]]=rubinvalidator(imputedsim222[(1+(xc-1)*rubindatasets3):(xc*rubindatasets3)],datasim22,truevalssim2,response,explanatory,frac=frac2,maxits=maxits2,datinpool=rubindatasets3)
rubinlistsim2[[length(rubinlistsim2)+1]]=rubinvalidator(imputedsim223[(1+(xc-1)*rubindatasets3):(xc*rubindatasets3)],datasim22,truevalssim2,response,explanatory,frac=frac2,maxits=maxits3,datinpool=rubindatasets3)
rubinlistsim2[[length(rubinlistsim2)+1]]=rubinvalidator(imputedsim231[(1+(xc-1)*rubindatasets3):(xc*rubindatasets3)],datasim23,truevalssim2,response,explanatory,frac=frac3,maxits=maxits1,datinpool=rubindatasets3)
rubinlistsim2[[length(rubinlistsim2)+1]]=rubinvalidator(imputedsim232[(1+(xc-1)*rubindatasets3):(xc*rubindatasets3)],datasim23,truevalssim2,response,explanatory,frac=frac3,maxits=maxits2,datinpool=rubindatasets3)
rubinlistsim2[[length(rubinlistsim2)+1]]=rubinvalidator(imputedsim233[(1+(xc-1)*rubindatasets3):(xc*rubindatasets3)],datasim23,truevalssim2,response,explanatory,frac=frac3,maxits=maxits3,datinpool=rubindatasets3)
 
 
       #rubin-validating simulations control
rubinlistsimcont1[[length(rubinlistsimcont1)+1]]=rubinvalidator(imputedsimcont11[(1+(xc-1)*rubindatasets3):(xc*rubindatasets3)],datasim11,truevalssim1,response,explanatory,frac=frac1,maxits=1,datinpool=rubindatasets3)
rubinlistsimcont1[[length(rubinlistsimcont1)+1]]=rubinvalidator(imputedsimcont12[(1+(xc-1)*rubindatasets3):(xc*rubindatasets3)],datasim12,truevalssim1,response,explanatory,frac=frac2,maxits=1,datinpool=rubindatasets3)
rubinlistsimcont1[[length(rubinlistsimcont1)+1]]=rubinvalidator(imputedsimcont13[(1+(xc-1)*rubindatasets3):(xc*rubindatasets3)],datasim13,truevalssim1,response,explanatory,frac=frac3,maxits=1,datinpool=rubindatasets3)
rubinlistsimcont2[[length(rubinlistsimcont2)+1]]=rubinvalidator(imputedsimcont21[(1+(xc-1)*rubindatasets3):(xc*rubindatasets3)],datasim21,truevalssim2,response,explanatory,frac=frac1,maxits=1,datinpool=rubindatasets3)
rubinlistsimcont2[[length(rubinlistsimcont2)+1]]=rubinvalidator(imputedsimcont22[(1+(xc-1)*rubindatasets3):(xc*rubindatasets3)],datasim22,truevalssim2,response,explanatory,frac=frac2,maxits=1,datinpool=rubindatasets3)
rubinlistsimcont2[[length(rubinlistsimcont2)+1]]=rubinvalidator(imputedsimcont23[(1+(xc-1)*rubindatasets3):(xc*rubindatasets3)],datasim23,truevalssim2,response,explanatory,frac=frac3,maxits=1,datinpool=rubindatasets3)
 
       #rubin-validating real algorithm
rubinlist[[length(rubinlist)+1]]=rubinvalidator(imputed11[(1+(xc-1)*rubindatasets3):(xc*rubindatasets3)],data1,truevals,response,explanatory,frac=frac1,maxits=maxits1,datinpool=rubindatasets3)
rubinlist[[length(rubinlist)+1]]=rubinvalidator(imputed12[(1+(xc-1)*rubindatasets3):(xc*rubindatasets3)],data1,truevals,response,explanatory,frac=frac1,maxits=maxits2,datinpool=rubindatasets3)
rubinlist[[length(rubinlist)+1]]=rubinvalidator(imputed13[(1+(xc-1)*rubindatasets3):(xc*rubindatasets3)],data1,truevals,response,explanatory,frac=frac1,maxits=maxits3,datinpool=rubindatasets3)
rubinlist[[length(rubinlist)+1]]=rubinvalidator(imputed21[(1+(xc-1)*rubindatasets3):(xc*rubindatasets3)],data2,truevals,response,explanatory,frac=frac2,maxits=maxits1,datinpool=rubindatasets3)
rubinlist[[length(rubinlist)+1]]=rubinvalidator(imputed22[(1+(xc-1)*rubindatasets3):(xc*rubindatasets3)],data2,truevals,response,explanatory,frac=frac2,maxits=maxits2,datinpool=rubindatasets3)
rubinlist[[length(rubinlist)+1]]=rubinvalidator(imputed23[(1+(xc-1)*rubindatasets3):(xc*rubindatasets3)],data2,truevals,response,explanatory,frac=frac2,maxits=maxits3,datinpool=rubindatasets3)
rubinlist[[length(rubinlist)+1]]=rubinvalidator(imputed31[(1+(xc-1)*rubindatasets3):(xc*rubindatasets3)],data3,truevals,response,explanatory,frac=frac3,maxits=maxits1,datinpool=rubindatasets3)
rubinlist[[length(rubinlist)+1]]=rubinvalidator(imputed32[(1+(xc-1)*rubindatasets3):(xc*rubindatasets3)],data3,truevals,response,explanatory,frac=frac3,maxits=maxits2,datinpool=rubindatasets3)
rubinlist[[length(rubinlist)+1]]=rubinvalidator(imputed33[(1+(xc-1)*rubindatasets3):(xc*rubindatasets3)],data3,truevals,response,explanatory,frac=frac3,maxits=maxits3,datinpool=rubindatasets3)
 
       #rubin-validating real control
rubinlistcont[[length(rubinlistcont)+1]]=rubinvalidator(imputedcont1[(1+(xc-1)*rubindatasets3):(xc*rubindatasets3)],data1,truevals,response,explanatory,frac=frac1,maxits=1,datinpool=rubindatasets3)
rubinlistcont[[length(rubinlistcont)+1]]=rubinvalidator(imputedcont2[(1+(xc-1)*rubindatasets3):(xc*rubindatasets3)],data2,truevals,response,explanatory,frac=frac2,maxits=1,datinpool=rubindatasets3)
rubinlistcont[[length(rubinlistcont)+1]]=rubinvalidator(imputedcont3[(1+(xc-1)*rubindatasets3):(xc*rubindatasets3)],data3,truevals,response,explanatory,frac=frac3,maxits=1,datinpool=rubindatasets3)
...
rubinlistmice[[length(rubinlistmice)+1]]=rubinvalidator(micedats,data1,truevals,response,explanatory,frac=frac1,maxits=0,datinpool=rubindatasets3)
...
rubinlistmice[[length(rubinlistmice)+1]]=rubinvalidator(micedats,data2,truevals,response,explanatory,frac=frac2,maxits=0,datinpool=rubindatasets3)
...
rubinlistmice[[length(rubinlistmice)+1]]=rubinvalidator(micedats,data3,truevals,response,explanatory,frac=frac3,maxits=0,datinpool=rubindatasets3)
     }
     ...
     imputedsim111=imputedsim111[-c(1:(xc*rubindatasets3))]
     imputedsim112=imputedsim112[-c(1:(xc*rubindatasets3))]
     imputedsim113=imputedsim113[-c(1:(xc*rubindatasets3))]
     imputedsim121=imputedsim121[-c(1:(xc*rubindatasets3))]
     imputedsim122=imputedsim122[-c(1:(xc*rubindatasets3))]
     imputedsim123=imputedsim123[-c(1:(xc*rubindatasets3))]
     imputedsim131=imputedsim131[-c(1:(xc*rubindatasets3))]
     imputedsim132=imputedsim132[-c(1:(xc*rubindatasets3))]
     imputedsim133=imputedsim133[-c(1:(xc*rubindatasets3))]
     imputedsim211=imputedsim211[-c(1:(xc*rubindatasets3))]
     imputedsim212=imputedsim212[-c(1:(xc*rubindatasets3))]
     imputedsim213=imputedsim213[-c(1:(xc*rubindatasets3))]
     imputedsim221=imputedsim221[-c(1:(xc*rubindatasets3))]
     imputedsim222=imputedsim222[-c(1:(xc*rubindatasets3))]
     imputedsim223=imputedsim223[-c(1:(xc*rubindatasets3))]
     imputedsim231=imputedsim231[-c(1:(xc*rubindatasets3))]
     imputedsim232=imputedsim232[-c(1:(xc*rubindatasets3))]
     imputedsim233=imputedsim233[-c(1:(xc*rubindatasets3))]
 
     imputedsimcont11=imputedsimcont11[-c(1:(xc*rubindatasets3))]
     imputedsimcont12=imputedsimcont12[-c(1:(xc*rubindatasets3))]
     imputedsimcont13=imputedsimcont13[-c(1:(xc*rubindatasets3))]
     imputedsimcont21=imputedsimcont21[-c(1:(xc*rubindatasets3))]
     imputedsimcont22=imputedsimcont22[-c(1:(xc*rubindatasets3))]
     imputedsimcont23=imputedsimcont23[-c(1:(xc*rubindatasets3))]
 
     imputed11=imputed11[-c(1:(xc*rubindatasets3))]
     imputed12=imputed12[-c(1:(xc*rubindatasets3))]
     imputed13=imputed13[-c(1:(xc*rubindatasets3))]
     imputed21=imputed21[-c(1:(xc*rubindatasets3))]
     imputed22=imputed22[-c(1:(xc*rubindatasets3))]
     imputed23=imputed23[-c(1:(xc*rubindatasets3))]
     imputed31=imputed31[-c(1:(xc*rubindatasets3))]
     imputed32=imputed32[-c(1:(xc*rubindatasets3))]
     imputed33=imputed33[-c(1:(xc*rubindatasets3))]
 
     imputedcont1=imputedcont1[-c(1:(xc*rubindatasets3))]
     imputedcont2=imputedcont2[-c(1:(xc*rubindatasets3))]
     imputedcont3=imputedcont3[-c(1:(xc*rubindatasets3))]
   }
 
   if ((it/parallelimp)%%(holecycle*datbatches)==0) {
...
write.csv(outlistsim1$totmiss,paste0(dirnamesim1,"/totmiss.csv"))
     ...
     if (class(rubinlistsim1)!="try-error") {write.csv(rubinlistsim1,paste0(dirnamesim1,"/rubin_parameters.csv"))}
rubinlistmicesim1=lapply(rubinlistmicesim1,function(x){rbind(x,-1)})
     if (class(rubinlistsim1)!="try-error") {rubinlistmicesim1=do.call(rbind,rubinlistmicesim1);write.csv(rubinlistmicesim1,paste0(dirnamesim1,"/rubin_parameters_mice.csv"))}
...
write.csv(outlistsim2$totmiss,paste0(dirnamesim2,"/totmiss.csv"))
     ...
     if (class(rubinlistsim1)!="try-error") {rubinlistsim2=do.call(rbind,rubinlistsim2);write.csv(rubinlistsim2,paste0(dirnamesim2,"/rubin_parameters.csv"))}
rubinlistmicesim2=lapply(rubinlistmicesim2,function(x){rbind(x,-1)})
     if (class(rubinlistsim1)!="try-error") {rubinlistmicesim2=do.call(rbind,rubinlistmicesim2);write.csv(rubinlistmicesim2,paste0(dirnamesim2,"/rubin_parameters_mice.csv"))}
...
rubinlistsimcont1=lapply(rubinlistsimcont1,function(x){rbind(x,-1)})
     if (class(rubinlistsim1)!="try-error") {rubinlistsimcont1=do.call(rbind,rubinlistsimcont1);write.csv(rubinlistsimcont1,paste0(dirnamesimcont1,"/rubin_parameters.csv"))}
...
rubinlistsimcont2=lapply(rubinlistsimcont2,function(x){rbind(x,-1)})
     if (class(rubinlistsim1)!="try-error") {rubinlistsimcont2=do.call(rbind,rubinlistsimcont2);write.csv(rubinlistsimcont2,paste0(dirnamesimcont2,"/rubin_parameters.csv"))}
...
valid=cbind(dataset=0,NAset=NAset,frac=outlist$frac,maxits=outlist$maxits,reldif=outlist$reldif,covdifmed=abs(outlist$covdifmed),editerr=outlist$editerr)
     ...
     if (class(rubinlistsim1)!="try-error") {rubinlist=do.call(rbind,rubinlist);write.csv(rubinlist,paste0(dirname,"/rubin_parameters.csv"))}
     rubinlistmice=lapply(rubinlistmice,function(x){rbind(x,-1)})
     if (class(rubinlistsim1)!="try-error") {rubinlistmice=do.call(rbind,rubinlistmice);write.csv(rubinlistmice,paste0(dirname,"/rubin_parameters_mice.csv"))}
...
write.csv(outlistcont$totmiss,paste0(dirnamecont,"/totmiss.csv"))
     ...
     if (class(rubinlistsim1)!="try-error") {rubinlistcont=do.call(rbind,rubinlistcont);write.csv(rubinlistcont,paste0(dirnamecont,"/rubin_parameters.csv"))}
